...
#define APP_IDLE_WATCHDOG_KICK_INTERVAL_TICKS \
  100U /**< watchdog kick period in OS ticks */
...
void app_idle_hook(void)
{
  ...
  if ((current_tick - last_watchdog_kick_tick) >=
      APP_IDLE_WATCHDOG_KICK_INTERVAL_TICKS) {
