...
#define APP_TASK_PLACEHOLDER_DELAY_MS \
...
void app_tasks_create(void)
{
  static const app_task_definition_t task_definitions[] = {
    { &radiolink_task_handle, "radiolink", APP_TASK_STACK_SMALL_BYTES,
      osPriorityHigh, radiolink_task },
    { &usblink_rx_task_handle, "usblinkRx", APP_TASK_STACK_SMALL_BYTES,
      osPriorityAboveNormal, usblink_rx_task },
    { &usblink_tx_task_handle, "usblinkTx", APP_TASK_STACK_SMALL_BYTES,
      osPriorityNormal, usblink_tx_task },
    { &atkp_tx_task_handle, "atkpTx", APP_TASK_STACK_SMALL_BYTES,
      osPriorityNormal, atkp_tx_task },
    { &atkp_rx_task_handle, "atkpRx", APP_TASK_STACK_MEDIUM_BYTES,
      osPriorityHigh, atkp_rx_task },
    { &config_service_task_handle, "configSvc", APP_TASK_STACK_SMALL_BYTES,
      osPriorityLow, app_task_placeholder_entry },
    { &pm_service_task_handle, "pmSvc", APP_TASK_STACK_SMALL_BYTES,
      osPriorityBelowNormal, app_task_placeholder_entry },
    { &sensors_task_handle, "sensors", APP_TASK_STACK_LARGE_BYTES,
      osPriorityAboveNormal, sensors_task },
    { &stabilizer_task_handle, "stabilizer", APP_TASK_STACK_LARGE_BYTES,
      osPriorityHigh, stabilizer_task },
    { &module_manager_task_handle, "moduleMgr", APP_TASK_STACK_SMALL_BYTES,
      osPriorityLow, module_manager_task },
  };

  for (uint32_t index = 0;
       index < (sizeof(task_definitions) / sizeof(task_definitions[0]));
       ++index) {
    ...
    *task_definition->handle =
      osThreadNew(task_definition->func, NULL, &attributes);
