...
#define WIFI_THRUST_MID \
  32768 /**< thrust value that signals mode switch to RC */
#define WIFI_THRUST_LOW 10000 /**< previous thrust threshold for mode switch */
#define WIFI_THRUST_ZERO \
  256 /**< thrust value that signals mode switch to idle */
...
void wifi_module_init(void)
{
  ...
  xTaskCreate(wifi_rx_task, "WIFILINK", WIFI_TASK_STACK, NULL, WIFI_TASK_PRIO,
              &task_handle);
